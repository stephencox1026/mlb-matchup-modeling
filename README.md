...
Model calibration and feature-importance diagnostics generated by the pipeline:

![Calibration curve](docs/figures/calibration_curve.png)
![SHAP feature importance](docs/figures/shap_beeswarm_random_forest.png)
![Statcast expected value](docs/figures/statcast_ev_2026.png)
![OPS vs LHP/RHP](docs/figures/ops_lhp_vs_rhp_2026.png)
